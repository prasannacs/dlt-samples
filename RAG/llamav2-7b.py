...
mlflow.set_experiment("/Users/prasanna.selvaraj@databricks.com/llamav2-7b")
...
registered_name = "prasanna.rag.llama2_7b_completions" # Note that the UC model name follows the pattern <catalog_name>.<schema_name>.<model_name>, corresponding to the catalog, schema, and registered model name
...
endpoint_name = 'jingos-llama2-7b-completions'
